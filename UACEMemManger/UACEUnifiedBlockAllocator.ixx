...
//
//	public:
//		constexpr void deallocMem(char* ptr, UACE::MemManager::mem_t size)
//		{
//
//			const UACE::MemManager::mem_t currOffset{ static_cast<UACE::MemManager::mem_t>(ptr - this->ptr) };
...
//		}
//
//		void constexpr init(char* dataPtr, MemManager::mem_t size)
//		{
//			this->ptr = dataPtr;
//			this->aLens.front() = size;
//		}
//
//		[[nodiscard]] constexpr char* requestMemory(MemManager::mem_t size)
//		{
//
//			//Would not compile if requestMemody is constexpr in vs2022 std:c++latest (20.12.2021)
////			const auto fLen{ std::ranges::find_if(this->aLens, [this, size](MemManager::mem_t& len)
////			{
////				return len >= size;
////			}) };
//			const auto fLen{ std::find_if(this->aLens.begin(), this->aLens.end(), [this, size](MemManager::mem_t& len)
//			{
//				return len >= size;
//			}) };
//
...
//
//	private:
//		std::array<MemManager::mem_t, 32> aLens{};
//		std::array<MemManager::mem_t, 32> aPtrOffset{};
//
//	};
//
...
//
//	public:
//		constexpr UnifiedBlockAllocator(MemManager::mem_t size, char* dataPtr) 
//			: size(size)
//		{
...
//	private:
//
//		constexpr void dealloc(char* ptr, UACE::MemManager::mem_t size)
//		{
...
//
//	private:
//		MemManager::mem_t size{ 0 };
//
//	};
//
//	UnifiedBlockAllocator constexpr createAllocator(Domain* domain, MemManager::mem_t size)
//	{
//
